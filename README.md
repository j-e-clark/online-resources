...
| [How to start an Online Business](https://www.shopify.com/blog/online-business-ideas)                                                | Shopify Blog: 29 Business Ideas                                                                                                                            |
...
| [CSS Selector Specificity](https://polypane.app/css-specificity-calculator/)                          | Calculate the specificity of selectors all the way up to CSS Selectors level 4                                                                                                           |
...
| [modern.css](https://modern-css.com)                                                                  | Modern CSS code snippets, side by side with the old hacks they replace. Every technique you still Google has a clean, native replacement now.                                            |
...
| [ReliCSS](https://www.alwaystwisted.com/relicss/)                                                     | ReliCSS, by [Stu Robson](https://www.alwaystwisted.com), is a dedicated scanner that analyses CSS to identify historical artifacts or "browser hacks" that can riddle older stylesheets. |
...
| [Sorted CSS colors](https://enes.in/sorted-colors/)                                                   | A tool to sort the named CSS colors in a way that it shows related colors together.                                                                                                      |
...
| [\_Email.md\_](https://www.emailmd.dev/)                                                                                  | Responsive Emails, Written in Markdown                                                                                                          |
...
| [Electricty Maps](https://app.electricitymaps.com)                                                                                               | Electricity Maps provides global access to electricity mix, prices, load, and carbon intensity. Available in real-time, historically and forecasted.                                                           |
...
| [Energy Dashboard](https://www.energydashboard.co.uk/live)                                                                                       | Real‑time electricity generation, demand, and carbon intensity data for Great Britain, updated every 5–30 minutes                                                                                              |
...
| [Gridwatch](https://gridwatch.templar.co.uk)                                                                                                     | GB National Grid status displayed in terms of analogue instruments and moving graphs                                                                                                                           |
...
| [Octopus Energy Agile Portal](https://agile.octopushome.net/dashboard)                                                                           | Dashboard showing Agile import and export tariffs                                                                                                                                                              |
...
| [HTML for People](https://htmlforpeople.com)                                                                                                                                                          | Blake Watson has written a book covering everything you need to know to get started in an approachable and friendly way. |
...
| [Current AQI Map](https://air-quality-edge-functions.netlify.app)                                                                           | This is a demo of updating a map to show air quality data for the user’s current location using Next.js Advanced Middleware, powered by Netlify Edge Functions. |
...
| [Javascript for Web Designers](https://javascript-for-web-designers.abookapart.com)                                                                  | Mat Marquis’ JavaScript for Web Designers by A Book Apart is published online for free.                                                                                                                                                                                                                                                                                                                                                                                  |
...
| [replacements.fyi](https://replacements.fyi)                                                                                                         | type a package name. they'll tell you what you don't need.                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| [Existential Audio](https://existential.audio)                                           | Developer of BlackHole. A modern macOS virtual audio loopback driver.                                                                                                                                        |
...
| Website                                                                                 | Description                                                                                                                                                                                                                                                                   |
| --------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [API Probe](https://apiprobe.dev)                                                       | Simple & Powerful API Testing. From Brad Traversy of Traversy Media.                                                                                                                                                                                                          |
| [ApiMocker](https://apimocker.com)                                                      | A comprehensive fake REST API service for developers. From Brad Traversy of Traversy Media.                                                                                                                                                                                   |
...
| [ClimateAction.Techj](https://climateaction.tech)                                       | Tech workers seeding climate action in companies, organisations and industries through deep, self-organized community building and support.                                                                                                                                   |
...
| [Dev Sheets](https://www.devsheets.io)                                                  | Modern developer cheat sheets for quick reference. From Brad Traversy of Traversy Media.                                                                                                                                                                                      |
...
| [Web Dev Helper Guide](https://webdev.bryanhogan.com)                                   | Your web developer guide. All about how to create a website with HTML & CSS, JS only if needed. Made by Bryan Hogan                                                                                                                                                           |
| [Learn Build Teach](https://www.learnbuildteach.com)                                    | Learn Build Teach is a welcoming and open community of web developers.                                                                                                                                                                                                        |
| [Learn UI Design Tools](https://www.learnui.design/tools/)                              | Tools for designers - Gradient Generator, Data Visualisation Colour Picker, Accessible Colour Generator                                                                                                                                                                       |
...
| [Plain Vanilla Web](https://plainvanillaweb.com)                                        | An explainer for doing web development using only vanilla techniques. No tools, no frameworks — just HTML, CSS, and JavaScript.                                                                                                                                               |
| [Pro Git](https://git-scm.com/book/en/v2)                                               | The entire Pro Git book, written by Scott Chacon and Ben Straub and published by Apress                                                                                                                                                                                       |
| [Resilient web design](https://resilientwebdesign.com)                                  | Resliient web design by Jeremy Keith                                                                                                                                                                                                                                          |
...
| [umami](https://umami.is)                                                               | Powerful analytics without the complexity. Set up in minutes, get insights immediately. No cookies required.                                                                                                                                                                  |
...
| [Web Utilities](https://webutils.io)                                                    | Privacy-first web utilities for developers, designers, and creators. From Brad Traversy of Traversy Media.                                                                                                                                                                    |
| [Website Carbon](https://www.websitecarbon.com)                                         | The original Website Carbon calculator                                                                                                                                                                                                                                        |
| [Website Spec](https://specification.website)                                           | A platform-agnostic specification of the technical features every decent website should have — from \<title\> to /.well-known/security.txt, from WCAG contrast to llms.txt. Written for humans and agents. - A checklist detailing what a good website does.                  |
...
| [16 Lesser Known Accessibility Issues](https://toward.studio/latest/16-lesser-known-accessibility-issues)                                             | Post from Toward with 16 A11y Tips                                                                                   |
| [Accessible Components](https://scottaohara.github.io/accessible_components/)                                                                         | Scott O'Hara's resource of accessible components                                                                     |
...
| [Accessibility Essentials](https://martijnhols.nl/blog/accessibility-essentials-every-front-end-developer-should-know?ck_subscriber_id=1679427849)    | Accessibility essentials every front-end developer should know                                                       |
